...
In addition to the regular TMIV rendering, support for MPI rendering is added to the softwarefootnote:tmiv71[] and described further in <<secMpiRenderer>>.
